...
* *Last Modification Date*: 01 11 2024
* *GitLab URL*: https://git.cs.dal.ca/hosler/csci3172/-/tree/main/labs/lab6?ref_type=heads
Note: once the program has run, run "cat Weather.txt" in the terminal to show the files output

## Authors

If what is being submitted is an individual Lab or Assignment, you may simply include your name and email address. Otherwise list the members of your group.

* [Nathan Hosler](nt712507@dal.ca) - (Lead Dev)
